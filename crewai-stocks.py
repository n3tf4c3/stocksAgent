...
stockPriceAnalyst = Agent(
	...
	backstory="""You're a highly experienced in analyzing the price of an specefic stock
...
get_news = Task(
	...
	Compose the results int a helpfull report""", 
...
writeAnalyses = Task(
	description = """Use the stock price trend and the stock news report to create an analyses and write the newsletter about the {ticket} company
  	than is brief and highlights the most important points.
